...
# UI Design
st.sidebar.image("C:\\Users\\91939\\Downloads\\DALL·E 2024-11-29 13.13.00 - A modern logo design for a Vision AI application. The logo features a stylized eye with a camera lens in the center, symbolizing vision and intelligen.webp", use_column_width=True)
...
#declearing the features
st.markdown("""
### Features
- 🏞️ **Scene Analysis**: Describe the content of an image in breif and detailed.
...
with tab1:
    ...
    if uploaded_file:
        ...
        with st.spinner("Analyzing Image..."):
            ...
            user_prompt = "Describe this image detailed,breif with more text, clearly and concisely for visually impaired individuals."
